...
![](images/Pasted image 20230428220224.png) }
...
\item
  \textbf{Download your region's OSM street network}: Trim the network to your region of interest so you can process the data faster. \tipbox{ Appendix \ref{osm-basics} explains how to extract street networks, and Appendix \ref{data} provides some packaged and external data sources for you to download OSM data. }
\item
...
\includegraphics{images/Pasted image 20230428221917.png}
...
\includegraphics{images/Pasted image 20230428222041.png}

\hypertarget{step-2.-prepare-it-in-depthmapx}{%
\paragraph*{Step 2. Prepare it in DepthMapX}\label{step-2.-prepare-it-in-depthmapx}}
\addcontentsline{toc}{paragraph}{Step 2. Prepare it in DepthMapX}
...
\includegraphics{images/Pasted image 20230428222344.png}
