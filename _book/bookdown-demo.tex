...
\begin{figure}
\centering
\includegraphics[width=14cm,height=\textheight]{images/20230322_134155.jpg}
\caption{\label{fig:ejipura} Buildings of Ejipura.}
\end{figure}

That's when I decided to use Ejipura as my lab and started exploring what makes a place walkable beyond \emph{conventional} ideas of walkability. Over the next few weeks, I fell in love with the neighborhood's tightly wound lanes, bustling shops, and vibrant buildings. Despite the language barrier, the residents were eager to contribute to my research, and I learned to use their insights to conduct detailed descriptive analyses of the neighborhood. As I delved deeper, I also realized that the issues affecting walkability were complex and intertwined with social identities, accessibility to public transport, and differing impacts on various groups of people. Rather than trying to assign a numerical value to the walkability of the neighborhood, I found more satisfaction in understanding and analyzing the complex factors at play. The rest is covered in the next few dozen pages.
...
This book \emph{does assume you have some understanding of walkability audits and assessments}, and what you are looking for is methods to fill gaps in that knowlege. Little-to-no prior knowledge is required for following the methods discussed in this book. You might be a:
...
\includegraphics{images/cmp-02.png}
...
Think of your city and how it is designed, can you walk in it without weaving through haphazardly parked cars, broken sidewalks, and other obstacles? Unfortunately, planning for walkable cities has received far less attention, funding, and seriousness than its motorized counterparts. Shown alongside is some data from the `\emph{Comprehensie Mobility Plan for Bengalurur (2020)}' by the Directorate of Urban Land Transport. Pedestrian infrastructure receives the \emph{least} amount of money by a factor of nearly 20 times.
...
\begin{quote}
All further augmentation of urban road capacity, be it at-grade or along elevated corridors, should pay particular attention to the equitable allocation of road space, and should prioritise movements of public transport vehicles, pedestrians and bicyclists. - CMP 2020, \emph{DULT}
\end{quote}

This is not unique to Bangalore. Most Indian cities have undergone a rapid urban expansion that has mostly been geared towards cars, resulting in sprawls that are impossible to navigate without them. As a result, we often find ourselves in cities where walking is either inconvenient or downright dangerous, particularly for those with disabilities or who are otherwise marginalized \autocite{ComprehensiveMobilityPlan2020}.

\begin{figure}
\centering
\includegraphics[width=15cm,height=\textheight]{images/20230210_120025.jpg}
\caption{\label{fig:kengeri} Without proper footpaths or easy connectivity to less busy roads, pedestrians are left to navigate a busy highway right after they leave the Kengeri metro station.}
\end{figure}

Over the years, there have been many, many attempts at getting to the root of what making something walkable means.

Research has suggested that a range of factors contribute to walkability, including the presence of sidewalks and crosswalks, street lighting, traffic calming measures, proximity to destinations such as schools and shops, and the overall design and layout of the built environment \autocite{spearsReviewPedestrianTransitOriented2017}. These factors can vary from place to place and even from one street to the next, making it challenging to create a single, definitive definition of walkability. Planners, policymakers, and community activists in India are working together to create spaces in cities that prioritize pedestrians, with more accessible sidewalks, dedicated bike lanes, and improved public transportation. These efforts are not only good for public health and the environment but also local economies. Studies have shown that neighborhoods with higher walkability ratings tend to have higher property values and more vibrant local businesses \autocite{Jacobs1961Death2011,spearsReviewPedestrianTransitOriented2017}.
...
\caption{\label{fig:levels} Seeing the neighborhood as a sum of its parts.}
\end{figure}
...
\hypertarget{why-do-we-need-them}{%
\subsection{Why do we need them?}\label{why-do-we-need-them}}
...
\hypertarget{differences-in-methods}{%
\subsection{Differences in methods}\label{differences-in-methods}}
...
\begin{figure}
\centering
\includegraphics[width=10cm,height=\textheight]{images/Pasted image 20230428220224-01.png}
\caption{\label{fig:pop-point} The global coverage makes GHSL a very useful source of data on population.}
\end{figure}
...
\caption{\label{fig:base-map-awap} Load in a simple base map of city blocks for your interest area.}
\end{figure}
...
\caption{\label{fig:permeable} Hexagon grid with colors mapped to values.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=10cm,height=\textheight]{images/connectivity-1.png}
\caption{\label{fig:connectivity-one} There's a lot going on this map, can we simplify it?}
\end{figure}
...
\caption{Tweak the color ranges to your liking}
\end{figure}
...
\caption{\label{fig:connectivity-two} Visualizing connectivity}
\end{figure}
...
\caption{\label{fig:isoselect} We can also choose to visualize an entire point layer}
\end{figure}
...
\caption{\label{fig:isoinput} Setting up the isochrone}
\end{figure}
...
\caption{Search for your area of interest on Sentinel...}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=8cm,height=\textheight]{images/gc-2-01.png}
\caption{\label{fig:search} ...and then select your data source.}
\end{figure}
...
\caption{\label{fig:single-result} Search for images with least cloud cover so your data analysis can be better.}
\end{figure}
...
\item
  ...
  \begin{figure}
  \centering
  \includegraphics[width=10cm,height=\textheight]{images/basemaps-01.png}
  \caption{\label{fig:basemaps} We used plain basemaps of Ejipura to color code roads based on how we felt while walking on them, how easy it was to walk and other landmarks we came across.}
  \end{figure}
\item
...
\item
  They may not be directly related to the scientific definition of comfort but can serve as proxies for it. Refer to \ref{tab:sample-feelings-measure} for examples.
\item
...
\begin{figure}
\centering
\includegraphics[width=8cm,height=\textheight]{images/temp.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.2214}}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=\textheight]{images/built-environment-01.png}
\caption{\label{fig:built-environment-info} Observations on the built environment through notes and illustrations.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=15cm,height=\textheight]{images/infrastructure-info.png}
\caption{\label{fig:infrastructure-info} Access and connectivity of public transport in Ejipura. The poor planning of systems results in low uptake even though there are many bus stops available to locals.}
\end{figure}
