# (PART) Quantative Assessment Guides {-}
...
2.  **Download your region's OSM street network**: Trim the network to your region of interest so you can process the data faster. \tipbox{ Appendix @ref(osm-basics) explains how to extract street networks, and Appendix @ref(data) provides some packaged and external data sources for you to download OSM data. }
...
![](images/Pasted%20image%2020230428221917.png)
...
![](images/Pasted%20image%2020230428222041.png)
...
![](images/Pasted%20image%2020230428222344.png)
